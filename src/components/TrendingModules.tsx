...
export default function TrendingModules() {
  ...
  const getModules = async () => {
    setIsLoading(true);
    try {
      const res = await ModuleService.getTrendingModules(user.id);
  ...
  const handleOpenModule = async (module: any) => {
    try {
      await ModuleService.startModuleTracking(module.id, user?.id);
  ...
  return (
    <div>
      <div className="mt-2 p-4">
        <div className="text-lg text-start font-semibold">Trending Modules</div>
          ...
          : modules.map((module: any) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 mt-3 text-sm text-start">
